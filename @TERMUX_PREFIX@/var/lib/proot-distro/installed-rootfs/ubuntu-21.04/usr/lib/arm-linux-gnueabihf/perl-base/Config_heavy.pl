...
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/arm-linux-gnueabihf/10 /lib/arm-linux-gnueabihf /lib/../lib /usr/lib/arm-linux-gnueabihf/10 /usr/lib/arm-linux-gnueabihf /usr/lib/../lib /lib /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
